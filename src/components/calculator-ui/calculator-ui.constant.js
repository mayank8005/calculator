...
// special flag is used for btn, which needed on one operand like sqrt or no operand like clear
export const BUTTONS = [
  ...
  { label: "Clear", value: "clear", operator: true, special: true },
...
export const SCIENTIFIC_BUTTONS = [
  { label: "Sign button", value: "sign", operator: true, special: true },
  { label: "Square", value: "square", operator: true, special: true },
  { label: "Square root", value: "root", operator: true, special: true },
];
